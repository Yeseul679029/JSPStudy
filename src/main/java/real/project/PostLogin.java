...
public class PostLogin extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		/* 서블릿이 직접 요청을 받으므로 application내장객체는 아래 메서드를
		통해 얻어와야 한다 */
		...
		JSON은 객체와 배열로 구분되는 객체인 경우 JSONObject객체를
		사용하고, 배열인 경우 JSONArray 객체를 사용한다. */
		...
		if(dto.getName()!=null) {
			...
			String html = "";
			html+="<table class= 'table table-boardered' style='width:300px;'>";
			html+="<tr>";
